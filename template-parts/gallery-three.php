<?php
/*
    Template Name: Gallery Three - Image and Text
*/
...
<!-- Shows posts of one selected category based on ID NTS: Change back category numbers when uploading to Phoenix // select a gallery post ID for this assignment -->
...
<?php 
    ...
    $args = array('showposts'=>5, 'cat'=>25, 'order'=>'ASC' ); 
